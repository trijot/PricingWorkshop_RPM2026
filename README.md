...
| Session 1              | GitHub introduction, version control basics, tool access, validation, reading/writing workflows, 
                         |  establishing a single source of truth                                                                                                 | Try / Sean  |
...
| Collaborative Exercise | Small-group case study; parallel implementation using RADAR and Python                                                                 | Sean (All    |  
